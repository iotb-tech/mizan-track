...
export async function fetchHabits(supabase:SupabaseClient<Database>, userId: string): Promise<Habit[]>{
    void supabase;
...
export async function createHabit(supabase:SupabaseClient<Database>,userId: string, input:CreateHabitInput ): Promise<Habit> {
    void supabase;
    void userId;
    void input;
