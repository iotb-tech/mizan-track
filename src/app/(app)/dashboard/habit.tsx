...
export function Habit({
  ...
  return (
    <div className="flex flex-col rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <button
        type="button"
        className="mt-4 w-full rounded-lg border border-gray-200 py-2.5 text-sm font-medium text-[#1976e8] transition hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800"
