...
export default function LayOut({
  ...
  const showBranding = isRegister || isLogin || isForgotPassword || isUpdatePassword;

  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-gray-950 md:grid md:grid-cols-2">

      {/* Branding Panel — hidden on mobile, visible md+ */}
      {showBranding && (
        <div className="hidden md:flex md:flex-col md:min-h-screen md:justify-center bg-[linear-gradient(145deg,#1d4ed8,#3b82f6)] px-0">
          <div className="flex flex-col justify-center">
            ...
            {/* Text */}
            <div className="px-8 pt-8 text-center sm:px-10 sm:pt-10 lg:px-16">
      ...
      {/* Form Panel */}
      <div
        className={`flex min-h-screen w-full items-center justify-center bg-neutral-50 px-4 py-8 dark:bg-gray-950 sm:px-6 md:px-8 ${
          !showBranding ? "md:col-span-2" : ""
        }`}
      >
